...
package CBE.Free_Tree_Initializer
with SPARK_Mode
is
   pragma Pure;
...
private
   ...
   type Child_State_Type is (Init_Block, Init_Node, Write_Block, Done);
   ...
   type Type_2_Level_Type is record
      Children       : Type_2_Node_Block_Type;
      Children_State : Children_State_Type;
   end record;

   subtype Type_1_Level_Index_Type is
      Tree_Level_Index_Type range
         Tree_Level_Index_Type'First + 2 .. Tree_Level_Index_Type'Last;
   ...
   type Object_Type is record
      ...
      Lvl_To_Write     : Tree_Level_Index_Type;
   ...
   function Max_T2_Child_Idx (Obj : Object_Type)
   return Type_2_Node_Block_Index_Type
   is (Type_2_Node_Block_Index_Type (Obj.Max_Child_Idx));
