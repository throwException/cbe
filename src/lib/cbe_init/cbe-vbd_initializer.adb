...
package body CBE.VBD_Initializer
with SPARK_Mode
is
            ...
            if not Primitive.Valid (Prim) then
               ...
               Prim         :=
                  Primitive.Valid_Object_No_Pool_Idx (
                     Read, False, Primitive.Tag_VBD_Init_Blk_Alloc, 0, 0);
   ...
   begin
      ...
      if Child_State = Init_Block then
         ...
         if not Primitive.Valid (Prim) then
            ...
            Prim         :=
               Primitive.Valid_Object_No_Pool_Idx (
                  Write, False, Primitive.Tag_VBD_Init_Blk_IO,
